...
class LanguageModel(nn.Module):
    def __init__(self, vocab_size, input_dim):
        ...
        self.bert = BertModel.from_pretrained(r"/Users/huilin/workspace/LearnNLP/bert-base-chinese", return_dict=False)
...
def build_model(vocab_size, char_dim):
    model = LanguageModel(vocab_size, char_dim)
    return model
...
def sampling_strategy(prob_distribution):
    ...
    if strategy == "greedy":
        ...
        prob_distribution = prob_distribution.to("cpu")
